...
(window.__ksnav=window.__ksnav||[]).push({
  ...
  techniques:(function(){var CS='../../case-studies/',PR='../../primitives/exploitation/';return [
    ...
    {name:'PTE manipulation for code execution',cat:'Code execution',layer:'kernel',asOf:'2026-09-03',basis:'cited',ev:function(s){
      ...
      return ['gated','Needs a kernel R/W primitive','Viable only with HVCI off.'];}},
    {name:'Unsigned driver loading',cat:'Code integrity',layer:'kernel',asOf:'2026-09-03',basis:'inferred',ev:function(s){
    ...
    {name:'Capcom-style CR4 / user-mode shellcode BYOVD',cat:'BYOVD (code)',layer:'kernel',asOf:'2026-09-03',basis:'cited',ev:function(s){
    ...
    {name:'Blocklisted MmMapIoSpace drivers (RTCore64, gdrv, ATSZIO64…)',cat:'BYOVD',layer:'kernel',asOf:'2026-09-03',basis:'inferred',ev:function(s){
    ...
    {name:'VTL 0 → VTL 1 secure-call interface abuse',cat:'Hypervisor surface',layer:'kernel',asOf:'2026-09-03',basis:'inferred',ev:function(s){
