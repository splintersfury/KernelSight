...
- [Patch Patterns](patch-patterns.md) -- what Microsoft's fixes look like for each bug class, with before/after pseudocode.
- [Mitigation Timeline](mitigation-timeline.md) -- when each kernel defense landed and how it shifted attacker techniques.
