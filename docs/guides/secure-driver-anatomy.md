...
<div class="ks-figure" markdown>
  <span class="ks-figure-label">FIG_015: Root Cause Distribution (157 CVEs)</span>
  <svg viewBox="0 0 700 240" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Horizontal bar chart showing root cause distribution across 157 CVEs">
    <!-- Unvalidated Input -->
  ...
  <p class="ks-figure-caption">Categories mapped from 157 CVEs in the KernelSight corpus. "Unvalidated Input" includes missing length checks, unchecked offsets, and unbounded copies.</p>
</div>
