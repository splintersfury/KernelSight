...
| `0x9C40E400` | BUFFERED | READ_WRITE |  |
...
- `0x80862007`: NEITHER I/O with no buffer validation
- `0x8086200B`: NEITHER I/O with no buffer validation
- `0x8086200F`: NEITHER I/O with no buffer validation
